...
// ignore_for_file: prefer_initializing_formals, depend_on_referenced_packages, unused_local_variable, no_leading_underscores_for_local_identifiers
...
import '../localstorage/local_db.dart';
import '../woo_create_order.dart';
import '../woo_customer.dart';
import '../woo_customer_download.dart';
import '../woo_error.dart';
import '../woo_order_payload.dart';
import '../woo_product_attr_term.dart';
import '../woo_product_category.dart';
import '../woo_product_shipping_class.dart';
import '../woo_product_tag.dart';
import '../woo_products.dart';
import '../woo_products_attributes.dart';
import '../woo_products_variation.dart';
import '../woo_shipping_method.dart';
import '../woo_shipping_zone.dart';
import '../woo_user.dart';
...
class WooCommerce {
  ...
  oldUpdateCustomer({required WooCustomer wooCustomer}) async {
  ...
  Future<WooCustomer> updateCustomer(
      {required int id, required Map data}) async {
  ...
  Future<WooOrder> updateOrder({required Map orderMap, required int id}) async {
